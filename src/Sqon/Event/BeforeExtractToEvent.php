...
/**
 * Manages the event before the Sqon managers extracts paths from a Sqon.
 *
 * @author Kevin Herrera <kevin@herrera.io>
 */
class BeforeExtractToEvent extends AbstractEvent
{
    /**
     ...
     * @var string
     */
    const NAME = 'sqon.before_extract_to';
    ...
    /**
     * Sets the path to the directory to extract to.
     *
    ...
    /**
     * Sets the paths in the Sqon to extract.
     *
    ...
    /**
     * Sets the flag to overwrite paths.
     *
